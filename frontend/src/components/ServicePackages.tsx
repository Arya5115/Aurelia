              ...
              >
                ...
                <div className="p-8 space-y-6">
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="font-display text-4xl font-semibold text-foreground">{formatInrAmount(pkg.price)}</span>
                    <span className="font-body text-sm text-muted-foreground line-through">{formatInrAmount(pkg.original)}</span>
                  </div>
