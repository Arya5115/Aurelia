          ...
          <div className="p-4 space-y-3">
            ...
            >
              ...
              <div>
                ...
                <p className="font-body text-xs text-muted-foreground">{businessInfo.whatsappDisplay}</p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <p className="font-body text-xs text-muted-foreground">{businessInfo.email}</p>
              </div>
              <Send size={14} className="ml-auto text-muted-foreground group-hover:text-foreground transition-colors" />
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="font-body text-xs text-muted-foreground">{businessInfo.phoneDisplay}</p>
              </div>
              <Send size={14} className="ml-auto text-muted-foreground group-hover:text-foreground transition-colors" />
            </a>
          </div>
